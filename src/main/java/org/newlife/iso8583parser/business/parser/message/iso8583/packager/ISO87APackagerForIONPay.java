 ...
 * @see ISOComponent
 */
public class ISO87APackagerForIONPay extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
            ...
            /*004*/ new IFA_NUMERIC ( 14, "AMOUNT, TRANSACTION"),
    ...
    public ISO87APackagerForIONPay() {
        super();
        ...
        iso8583Property.setIsoHeaderLength    ( 0         );
        iso8583Property.setMessageBound       ( "AFTERLL" );
        iso8583Property.setMessageFieldType   ( "DECIMAL" );
        iso8583Property.setMessageLength      ( 4         );

 ...
 * @see ISOComponent
 */
public class ISO87APackagerForVISA extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
            /*000*/ new IFA_NUMERIC (  4, "MESSAGE TYPE INDICATOR"),
            /*001*/ new IFA_BITMAP  ( 16, "BIT MAP"),
            /*002*/ new IFA_LLCHAR  ( 99, "PAN - PRIMARY ACCOUNT NUMBER"), //new IFA_LLNUM   ( 19, "PAN - PRIMARY ACCOUNT NUMBER"),
            ...
            /*022*/ new IF_CHAR     (  4, "POINT OF SERVICE ENTRY MODE"), //new IFA_NUMERIC (  3, "POINT OF SERVICE ENTRY MODE"),
            /*023*/ new IF_CHAR     (  3, "CARD SEQUENCE NUMBER"),//IFA_NUMERIC (  3, "CARD SEQUENCE NUMBER"),
            ...
            /*044*/ new IFA_LLLCHAR (999, "ADITIONAL RESPONSE DATA"),
            /*045*/ new IFA_LLLCHAR (999, "TRACK 1 DATA"),
            ...
            /*052*/ new IF_CHAR     ( 16, "PIN DATA"   ), //new IFA_BINARY  ( 16, "PIN DATA"   ),
            /*053*/ new IF_CHAR     ( 16, "SECURITY RELATED CONTROL INFORMATION"),//new IFA_NUMERIC ( 16, "SECURITY RELATED CONTROL INFORMATION"),
            ...
            /*121*/ new IF_CHAR     (  2, "RESERVED PRIVATE USE"), // 20240621 - Mushin request
    ...
    public ISO87APackagerForVISA() {
        ...
        iso8583Property.setIsoHeaderLength    ( 32        );

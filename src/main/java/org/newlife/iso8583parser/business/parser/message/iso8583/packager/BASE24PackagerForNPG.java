 ...
 */
public class BASE24PackagerForNPG extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
            ...
            /*040*/     new IF_CHAR     (  3, "SERVICE RESTRICTION CODE"),// Mike changed the following field to 16 bytes from 8 in ISO87A
            /*041*/     new IF_CHAR     ( 16, "CARD ACCEPTOR TERMINAL IDENTIFICACION"),
            /*042*/     new IF_CHAR     ( 15, "CARD ACCEPTOR IDENTIFICATION CODE" ),
            /*043*/     new IF_CHAR     ( 40, "CARD ACCEPTOR NAME/LOCATION"),// Mike changed the folowing field to 27 from 25 in ISO87A
            ...
            /*055*/     new IFA_LLLBINARY (999, "RESERVED ISO"),
            ...
            /*063*/     new IFA_LLLCHAR (999, "RESERVED PRIVATE"),// mike changed the following to 16 from 8 in ISO87A

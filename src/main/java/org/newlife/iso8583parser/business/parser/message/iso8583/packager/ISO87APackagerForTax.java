 ...
 * @see ISOComponent
 */
public class ISO87APackagerForTax extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
            ...
            /*032*/ new IFA_LLNUM   ( 99, "ACQUIRING INSTITUTION IDENT CODE"),
    ...
    public ISO87APackagerForTax() {
        ...
        iso8583Property.setIsoHeaderLength    ( 10          );
        iso8583Property.setMessageBound       ( "AFTERLL"   );
        iso8583Property.setMessageFieldType   ( "MPNBINARY" );
        iso8583Property.setMessageLength      ( 2           );
        iso8583Property.setMessageLengthOffset( 10          );

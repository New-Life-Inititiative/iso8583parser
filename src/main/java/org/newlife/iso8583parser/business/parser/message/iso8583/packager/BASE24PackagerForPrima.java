 ...
 */
public class BASE24PackagerForPrima extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
            /*000*/     new IFA_NUMERIC (  4, "MESSAGE TYPE INDICATOR"),
            /*001*/     new IFA_BITMAP  ( 16, "BIT MAP"),
            /*002*/     new IFA_LLCHAR  ( 99, "PAN - PRIMARY ACCOUNT NUMBER"),
            ...
            /*007*/     new IF_CHAR     ( 10, "TRANSMISSION DATE AND TIME"),
            ...
            /*041*/     new IF_CHAR     ( 16, "CARD ACCEPTOR TERMINAL IDENTIFICACION"), // Mike changed the following field to 16 bytes from 8 in ISO87A
            /*042*/     new IF_CHAR     ( 15, "CARD ACCEPTOR IDENTIFICATION CODE" ),
            /*043*/     new IF_CHAR     ( 40, "CARD ACCEPTOR NAME/LOCATION"),
            /*044*/     new IFA_LLCHAR  ( 25, "ADITIONAL RESPONSE DATA"),// Mike changed the folowing field to 27 from 25 in ISO87A
            ...
            /*064*/     new IFA_BINARY  ( 16, "MESSAGE AUTHENTICATION CODE FIELD"),// mike changed the following to 16 from 8 in ISO87A
            ...
            /*103*/     new IFA_LLCHAR  ( 99, "ACCOUNT IDENTIFICATION 2"),
            ...
            /*123*/     new IFA_LLLCHAR (153, "S-123 CRYPTOGRAFIC SERVICE MESSAGE"),
    ...
    public BASE24PackagerForPrima() {
        super();
        setFieldPackager(fld);

        ISO8583Property iso8583Property = new ISO8583Property();

        iso8583Property.setAppendHexCode      ( "0x03"    );
        iso8583Property.setHexCodecYn         ( "N"       );
        iso8583Property.setIsoHeaderLength    ( 12        );
